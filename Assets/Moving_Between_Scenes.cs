...
public class Moving_Between_Scenes : ViveGrip_Object {
	...
	public void FadeCamera(Transform nextSphere)
	{
	...
	public void FadeCamera()
	{
		...
		//No fader, so just swap the camera position
		Camera.main.transform.parent.position = this.nextSphere.position;
